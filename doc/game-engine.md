...
| :--- | :--- | :--- | :--- | :--- |
| `KICK_LOW` | `+850 px/s` | `-280 px/s` | `0.40s` | شوت زمینی سریع و محکم به سمت دروازه حریف |
| `KICK_HIGH` | `+760 px/s` | `-760 px/s` | `0.46s` | شوت قوسی و هوایی (چیپ) برای عبور از بالای سر حریف |
| `KICK_CLEAR` | `±1000 px/s` | `-900 px/s` | `0.52s` | دفع اضطراری و پرقدرت رو به بالا؛ جهت افقی از محل توپ نسبت به بازیکن گرفته می‌شود و توپ پشت سر را هم دفع می‌کند |

> [!NOTE]
> سرعت بازیکن هنگام زدن شوت تا میزان `52%` به سرعت پرتاب توپ اضافه می‌شود؛ بنابراین شوت در حال دویدن شتاب بیشتری خواهد داشت. جهت شوت‌های زمینی و هوایی همیشه به سمت دروازه حریف است، اما جهت دفع از سمتی می‌آید که توپ نسبت به بدن بازیکن قرار دارد.
